...
import { confirmRideValidator, createRideValidator, endRideValidator, getFareValidator, startRideValidator } from '../validators/ride.validator.js';
...
router.get("/end-ride", authCaptain, endRideValidator, endRide);
